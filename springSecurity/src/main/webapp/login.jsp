...
<script type="text/javascript" >
 	$(function(){
		...
		$('#captcha,.captcha-a').click(function(){
			$('#captcha').attr("src","${pageContext.request.contextPath}/spring/image/captcha?time="+new Date());
		});
			    ...
			    <form class="form-horizontal" name="form1" id="form1" method="POST" action="<c:url value="/j_spring_security_check" />" >
				  ...
				  <div class="control-group">
				    ...
				    <div class="controls">
				      	...
				      	<img id="captcha" src='<c:url  value="/spring/image/captcha" />' class="span1"  style="float:none;cursor: pointer;" />
